...
if __name__ == '__main__':
    for erosivity_file in glob.glob(os.path.join(erosivity_dir, 'R*.tif')):
        ...
        args['results_suffix'] = 'baseline_' + os.path.splitext(os.path.basename(erosivity_file))[0]
...
if __name__ == '__main__':
    for erosivity_file in glob.glob(os.path.join(erosivity_dir, 'R*.tif')):
        args['erosivity_path'] = erosivity_file
        args['results_suffix'] = 'Escenario1_' + os.path.splitext(os.path.basename(erosivity_file))[0]
        natcap.invest.sdr.sdr.execute(args)
...
if __name__ == '__main__':
    for erosivity_file in glob.glob(os.path.join(erosivity_dir, 'R*.tif')):
        args['erosivity_path'] = erosivity_file
        args['results_suffix'] = 'Escenario2_' + os.path.splitext(os.path.basename(erosivity_file))[0]
        natcap.invest.sdr.sdr.execute(args)
