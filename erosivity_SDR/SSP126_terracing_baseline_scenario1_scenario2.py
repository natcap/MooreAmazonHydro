...
args = {
    'biophysical_table_path': 'C:/Users/jgldstn/Documents/MooreAmazonHydro/SDR_Biophysical_Chaglla_LUscenarios_terracing.csv',
...
erosivity_dir = r'G:/Shared drives/Moore Amazon Hydro/1_base_data/Climate data/Downscaled NC data/ssp126/pr/erosivityOutputs/'

if __name__ == '__main__':
    for erosivity_file in glob.glob(os.path.join(erosivity_dir, 'R*.tif')):
        args['erosivity_path'] = erosivity_file
        args['results_suffix'] = 'baseline_terracing_' + os.path.splitext(os.path.basename(erosivity_file))[0]
...
args = {
    ...
    'k_param': '3.0',
    'l_max': '122',
    'lulc_path': 'C:/Users/jgldstn/Documents/MooreAmazonHydro/Land Use Scenarios/LUCC_Escenario1.tif',
    'n_workers': '-1',
    'sdr_max': '1.0',
    'threshold_flow_accumulation': '1000',
    'watersheds_path': 'G:/Shared drives/Moore Amazon Hydro/2_models/SDR_SWY_data_inputs/projected/Chaglla_dam_watershed.shp',
...
if __name__ == '__main__':
    for erosivity_file in glob.glob(os.path.join(erosivity_dir, 'R*.tif')):
        args['erosivity_path'] = erosivity_file
        args['results_suffix'] = 'Escenario1_terracing_' + os.path.splitext(os.path.basename(erosivity_file))[0]
        natcap.invest.sdr.sdr.execute(args)
...
args = {
    ...
    'k_param': '3.0',
    'l_max': '122',
    'lulc_path': 'C:/Users/jgldstn/Documents/MooreAmazonHydro/Land Use Scenarios/LUCC_Escenario2.tif',
    'n_workers': '-1',
    'sdr_max': '1.0',
    'threshold_flow_accumulation': '1000',
    'watersheds_path': 'G:/Shared drives/Moore Amazon Hydro/2_models/SDR_SWY_data_inputs/projected/Chaglla_dam_watershed.shp',
...
if __name__ == '__main__':
    for erosivity_file in glob.glob(os.path.join(erosivity_dir, 'R*.tif')):
        args['erosivity_path'] = erosivity_file
        args['results_suffix'] = 'Escenario2_terracing_' + os.path.splitext(os.path.basename(erosivity_file))[0]
        natcap.invest.sdr.sdr.execute(args)
