...
if __name__ == '__main__':
    for erosivity_file in glob.glob(os.path.join(erosivity_dir, 'R*.tif')):
        ...
        args['results_suffix'] = 'Escenario3_terracing_' + os.path.splitext(os.path.basename(erosivity_file))[0]
...
if __name__ == '__main__':
    for erosivity_file in glob.glob(os.path.join(erosivity_dir, 'R*.tif')):
        args['erosivity_path'] = erosivity_file
        args['results_suffix'] = 'Escenario4_terracing_' + os.path.splitext(os.path.basename(erosivity_file))[0]
        natcap.invest.sdr.sdr.execute(args)
...
args = {
    ...
    'k_param': '3.0',
    'l_max': '122',
    'lulc_path': 'C:/Users/jgldstn/Documents/MooreAmazonHydro/Land Use Scenarios/LUCC_Escenario5.tif',
    'n_workers': '-1',
    'sdr_max': '1.0',
    'threshold_flow_accumulation': '1000',
    'watersheds_path': 'G:/Shared drives/Moore Amazon Hydro/2_models/SDR_SWY_data_inputs/projected/Chaglla_dam_watershed.shp',
...
if __name__ == '__main__':
    for erosivity_file in glob.glob(os.path.join(erosivity_dir, 'R*.tif')):
        args['erosivity_path'] = erosivity_file
        args['results_suffix'] = 'Escenario5_terracing_' + os.path.splitext(os.path.basename(erosivity_file))[0]
        natcap.invest.sdr.sdr.execute(args)
